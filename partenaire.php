...
<body>
	...
	<!-- PARTENAIRE -->
	<span class="anchor" id="partenaire"></span>	<!-- ce span permet d'arriver au bon endroit en utilisant le menu -->
	<section>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="section-title">
						<h1><?php echo PARTENAIRE ?></h1>
						<span class="st-border"></span>
						<?php include ('festival-'.$lang.'/partenaire.php') ?>
					</div>
				</div>
			</div>
		</div>
