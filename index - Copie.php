			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="st-navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
				    	<li><a href="index"><?php echo ACCUEIL ?></a></li>
				    	<li><a href="#services"><?php  echo PRESENTATION ?></a></li>
				    	<li><a href="#our-works"><?php echo PARTENAIRE ?></a></li>
				    	<li><a href="#pricing"><?php echo INFO ?></a></li>
				    	<li><a href="#our-team"><?php echo INSCRIPTION ?></a></li>
				    	<li><a href="#contact"><?php echo HISTORIQUE?></a></li>
				    	<li><a href="blog.html">Blog</a></li>
					
					<!-- boutons pour choix de langues -->

					<li><form action="index" method="post"><button type="submit" name="lang" value="fr">fr</button>
					<button  type="submit" name="lang" value="nl">nl</button>
					<button type="submit" name="lang" value="en">en</button></form></li>
					</ul>
				</div><!-- /.navbar-collapse -->
			</div><!-- /.container -->
		</nav>
	...
	<section id="slider">
		<div id="home-carousel" class="carousel slide" data-ride="carousel">			
			<div class="carousel-inner">
				<div class="item active" style="background-image: url(images/European_union_flag-8.jpg)">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h2>Festival 2016 </h2>
								<h1>Sur th&egrave;me de l'UE</h1>
							</div>
						</div>
					</div>					
				</div>
					...
					<div id="office-carousel" class="carousel slide" data-ride="carousel">			
						<div class="carousel-inner">
							<div class="item active">
								<img src="images/office/01.jpg" alt="">
							</div>
							<div class="item">
